	...
	IDxcIncludeHandler* includeHandler)
{
	...
	hr = shaderResult->GetOutput(DXC_OUT_ERRORS, IID_PPV_ARGS(&shaderBlob), nullptr);
	assert(SUCCEEDED(hr));
	// 成功したログを出す
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	IDxcBlob* pixelShaderBlob = CompileShader(L"Object#D.PS.hlsl",
	...
	//上
	vertexData[1] = { 0.0f,0.5f,8.0f,1.0f };
	//右下
	vertexData[2] = { 0.5f,-0.5f,0.8f,1.0f };
