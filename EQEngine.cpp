...
void EQEngine::Update()
{
	Render();
}

void EQEngine::UpdateEnd()
{
	StateChange();
}
...
void EQEngine::Draw(const Vector4& a, const Vector4& b, const Vector4& c)
{
	triangleCount_++;
...
IDxcBlob* EQEngine::CompileShader
(
...
void EQEngine::CreateRootSignature()
{
...
void EQEngine::SettingInputLayout()
{
...
void EQEngine::SettingBlendState()
{
	//すべての色要素を書き込む
...
void EQEngine::SettingRasterizerState()
{
	//裏面(時計回り)を表示しない
