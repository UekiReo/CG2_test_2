...
void MyEngine::VertexInitialize() 
{
	...
	vertexRight[0] = { 0.2f,0.4f,0.0f,1.0f };

	vertexLeft[1] = { -0.8f,-0.8f,0.0f,1.0f };
	vertexTop[1] = { -0.6f,-0.4f,0.0f,1.0f };
	vertexRight[1] = { -0.4f,-0.8f,0.0f,1.0f };

	vertexLeft[2] = { 0.4f,-0.8f,0.0f,1.0f };
	vertexTop[2] = { 0.6f,-0.4f,0.0f,1.0f };
	vertexRight[2] = { 0.8f,-0.8f,0.0f,1.0f };

	vertexLeft[3] = { 0.1f,0.1f,0.0f,1.0f };
	vertexTop[3] = { 0.3f,0.5f,0.0f,1.0f };
	vertexRight[3] = { 0.5f,0.1f,0.0f,1.0f };

	vertexLeft[4] = { -0.2f,-0.2f,0.0f,1.0f };
	vertexTop[4] = { 0.0f,0.2f,0.0f,1.0f };
	vertexRight[4] = { 0.2f,-0.2f,0.0f,1.0f };

	vertexLeft[5] = { 0.4f,0.4f,0.0f,1.0f };
	vertexTop[5] = { 0.6f,0.8f,0.0f,1.0f };
	vertexRight[5] = { 0.8f,0.4f,0.0f,1.0f };

	vertexLeft[6] = { -0.8f,-0.2f,0.0f,1.0f };
	vertexTop[6] = { -0.6f,0.2f,0.0f,1.0f };
	vertexRight[6] = { -0.4f,-0.2f,0.0f,1.0f };

	vertexLeft[7] = { -0.8f,0.4f,0.0f,1.0f };
	vertexTop[7] = { -0.6f,0.8f,0.0f,1.0f };
	vertexRight[7] = { -0.4f,0.4f,0.0f,1.0f };

	vertexLeft[8] = { -0.2f,-0.8f,0.0f,1.0f };
	vertexTop[8] = { 0.0f,-0.4f,0.0f,1.0f };
	vertexRight[8] = { 0.2f,-0.8f,0.0f,1.0f };

	vertexLeft[9] = { 0.4f,-0.2f,0.0f,1.0f };
	vertexTop[9] = { 0.6f,0.2f,0.0f,1.0f };
	vertexRight[9] = { 0.8f,-0.2f,0.0f,1.0f };
